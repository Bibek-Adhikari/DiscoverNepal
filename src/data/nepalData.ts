...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    elevation: '1,400 m',
    bestMonths: ['September', 'October', 'November', 'March', 'April', 'May'],
    description: 'One of the largest spherical stupas in the world and a major pilgrimage site, surrounded by Tibetan monasteries and a vibrant Buddhist community.',
    culturalSignificance: 'A UNESCO World Heritage Site and the spiritual heart of Tibetan Buddhism in Nepal, attracting thousands of devotees and pilgrims daily.',
    image: '/kathmandu-stupa.jpg',
  ...
  },
  {
    ...
    description: 'One of the most sacred Hindu temples in the world, situated on the banks of the Bagmati River, renowned for its pagoda architecture and sacred cremation ghats.',
    culturalSignificance: 'A UNESCO World Heritage Site dedicated to Lord Shiva, serving as the holiest Hindu temple in Nepal and a major pilgrimage destination across South Asia.',
    image: '/lumbini-garden.jpg',
  ...
  },
  {
    ...
    elevation: '1,350 m',
    bestMonths: ['September', 'October', 'November', 'March', 'April', 'May'],
    description: 'The former royal palace of Nepal, now a museum showcasing the opulent lifestyle of the Shah dynasty with its grand ceremonial halls and royal collections.',
    culturalSignificance: 'A symbol of Nepal\'s royal history, preserved as a museum following the abolition of the monarchy in 2008, offering insight into two and a half centuries of Shah rule.',
    image: '/bhaktapur-temple.jpg',
    coordinates: { lat: 27.7166, lng: 85.3168 },
    weatherCondition: 'Sunny',
    temperature: 23,
  },
  {
    ...
    elevation: '4,984 m',
    bestMonths: ['March', 'April', 'May', 'October', 'November'],
    description: 'Known as the "valley of glaciers", this classic trek passes through rhododendron forests, Tamang villages, and high alpine pastures with views of Langtang Lirung.',
    culturalSignificance: 'The route passes through the heartland of the Tamang people, showcasing their distinct Tibetan Buddhist culture, monasteries, and traditional way of life.',
    image: '/langtang-valley.jpg',
    coordinates: { lat: 28.1833, lng: 85.5167 },
    weatherCondition: 'Partly Cloudy',
    temperature: 5,
  },
  {
    ...
    elevation: '5,106 m',
    bestMonths: ['March', 'April', 'May', 'September', 'October', 'November'],
    description: 'A challenging and rewarding circuit trek around the world\'s eighth highest mountain, offering dramatic landscapes from subtropical forests to the high Larkya Pass.',
    culturalSignificance: 'A restricted area trek passing through remote Nubri and Tsum valleys, home to communities with deep roots in Tibetan Buddhism and ancient trans-Himalayan trade.',
    image: '/everest-summit.jpg',
  ...
  },
  {
    ...
    category: 'Trekking Routes',
    elevation: '3,210 m',
    bestMonths: ['March', 'April', 'October', 'November', 'December', 'January'],
    description: 'One of the most popular short treks in Nepal, famous for its stunning sunrise panorama over the Annapurna and Dhaulagiri ranges from Poon Hill viewpoint.',
    culturalSignificance: 'The trail passes through traditional Magar and Gurung villages, rhododendron forests, and terraced hillsides that reflect the rich cultural heritage of western Nepal.',
    image: '/annapurna-trekker.jpg',
    coordinates: { lat: 28.3967, lng: 83.6969 },
    weatherCondition: 'Clear',
    temperature: 8,
  },
  {
    ...
    elevation: '1,592 m',
    bestMonths: ['September', 'October', 'November', 'March', 'April', 'May'],
    description: 'Soar above the serene Phewa Lake with breathtaking views of the Annapurna range, considered one of the top paragliding destinations in the world.',
    culturalSignificance: 'A thrilling aerial experience that has made Pokhara synonymous with adventure tourism in Nepal, blending natural beauty with adrenaline-fueled exploration.',
    image: '/pokhara-lake.jpg',
    coordinates: { lat: 28.2209, lng: 83.9719 },
    weatherCondition: 'Clear',
    temperature: 22,
  },
  {
    id: 'bungee-jumping-last-resort',
    ...
    elevation: '1,160 m',
    bestMonths: ['September', 'October', 'November', 'March', 'April', 'May'],
    description: 'A 160-meter free fall over the raging Bhotekoshi River, one of the highest and most thrilling bungee jumps in the world, set in a dramatic river gorge near the Tibet border.',
    culturalSignificance: 'Established as a pioneering adventure tourism venture, the Last Resort has put Nepal on the global adventure sports map, supporting local communities along the Arniko Highway.',
    image: '/langtang-valley.jpg',
    coordinates: { lat: 27.9000, lng: 85.9333 },
    weatherCondition: 'Partly Cloudy',
    temperature: 18,
  },
  {
    id: 'zip-flying-pokhara',
    name: 'Zip Flying',
    provinceId: 'gandaki',
    districtId: 'kaski',
    category: 'Adventure Sports',
    elevation: '1,425 m',
    bestMonths: ['September', 'October', 'November', 'March', 'April', 'May'],
    description: 'The world\'s longest, steepest, and fastest zip line, flying at speeds up to 120 km/h over the valleys of Pokhara with a backdrop of the Annapurna Himalayan range.',
    culturalSignificance: 'A record-breaking adventure attraction that has elevated Pokhara\'s profile as the adventure capital of Asia, offering an unmatched combination of speed and mountain scenery.',
    image: '/pokhara-lake.jpg',
    coordinates: { lat: 28.2450, lng: 83.9800 },
    weatherCondition: 'Clear',
    temperature: 21,
  },
  {
    ...
    elevation: '8,849 m',
    bestMonths: ['March', 'April', 'May', 'October', 'November'],
    description: 'A UNESCO World Heritage Site encompassing Mount Everest and home to rare wildlife including the snow leopard, red panda, and Himalayan tahr in a dramatic high-altitude landscape.',
    culturalSignificance: 'Sacred homeland of the Sherpa people, whose mountaineering expertise and Buddhist culture are integral to the identity of the world\'s highest mountain region.',
    image: '/everest-summit.jpg',
    coordinates: { lat: 27.9306, lng: 86.7140 },
    weatherCondition: 'Snowy',
    temperature: -15,
  },
  {
    id: 'langtang-national-park',
    ...
    elevation: '7,246 m',
    bestMonths: ['March', 'April', 'May', 'October', 'November'],
    description: 'Nepal\'s first Himalayan national park, encompassing high-altitude forests, glaciers, and diverse wildlife including red pandas, snow leopards, and Himalayan black bears.',
    culturalSignificance: 'A protected Himalayan ecosystem supporting the distinct culture and traditions of the Tamang and Sherpa communities living within and around its boundaries.',
    image: '/langtang-valley.jpg',
    coordinates: { lat: 28.1500, lng: 85.4500 },
    weatherCondition: 'Cold',
    temperature: 3,
  },
  {
    id: 'nuwakot-village',
    name: 'Nuwakot Village',
    provinceId: 'bagmati',
    districtId: 'nuwakot',
    category: 'Cultural Villages',
    elevation: '1,128 m',
    bestMonths: ['September', 'October', 'November', 'March', 'April', 'May'],
    description: 'A historically significant hilltop village home to a well-preserved seven-storey palace fortress built by Prithvi Narayan Shah, offering panoramic views of the Trishuli Valley.',
    culturalSignificance: 'Nuwakot served as the strategic military headquarters during the unification of Nepal, making it one of the most important historical sites outside the Kathmandu Valley.',
    image: '/bhaktapur-temple.jpg',
    coordinates: { lat: 27.9900, lng: 85.1600 },
    weatherCondition: 'Sunny',
    temperature: 24,
  },
  {
    ...
    elevation: '1,350 m',
    bestMonths: ['September', 'October', 'November', 'March', 'April', 'May'],
    description: 'The vibrant tourist hub of Kathmandu, a lively labyrinth of narrow streets packed with shops, restaurants, cafes, and guesthouses catering to travellers from across the globe.',
    culturalSignificance: 'A melting pot of Nepali and global cultures, Thamel has evolved into the commercial heart of Nepal\'s tourism industry while retaining its traditional Newari neighbourhood character.',
    image: '/hero-city-sunrise.jpg',
  ...
  },
  {
    ...
    elevation: '822 m',
    bestMonths: ['September', 'October', 'November', 'March', 'April', 'May'],
    description: 'A picturesque promenade along Phewa Lake lined with restaurants, shops, and cafes, offering tranquil reflections of the Annapurna range on the lake\'s still waters.',
    culturalSignificance: 'The social and commercial heart of Pokhara, blending the natural splendour of Nepal\'s largest Himalayan lake with a thriving multicultural tourism community.',
    image: '/pokhara-lake.jpg',
    coordinates: { lat: 28.2096, lng: 83.9565 },
    weatherCondition: 'Clear',
    temperature: 26,
  },
];
